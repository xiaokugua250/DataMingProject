...
public class HbaseDataOpt {
    ...
    public void delData(Table table, String tableName, String rowName, String colFamily, String col) {
        try {
            ...
            delete.addFamily(Bytes.toBytes(colFamily));                        // ɾ������
            delete.addColumn(Bytes.toBytes(colFamily), Bytes.toBytes(col));    // ɾ����
            table.delete(delete);
        } catch (IOException e) {
            e.printStackTrace();
        }
     ...
     * @param params
     */
    public void putAndUpdateData(Table table, String tableName, String rowName, String colFamily, String col,
