...
public class SparkAvgByCombineByKey {
    ...
    // merge
    Function2<SparkAvgCount, Integer, SparkAvgCount> addAndCount = new Function2<SparkAvgCount, Integer,
            SparkAvgCount>() {
    ...
    // combine
    Function2<SparkAvgCount, SparkAvgCount, SparkAvgCount> combine = new Function2<SparkAvgCount, SparkAvgCount,
            SparkAvgCount>() {
