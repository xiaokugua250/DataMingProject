...
public class SparkCountVector {
    ...
    public CountVectorizerModel getCountVectoreModel(String input, String output, DataFrame dataFrame,
                                                     String... params) {
    ...
    public CountVectorizerModel getCountVectoreModelByPriV(String[] vocabulary, String input, String output,
                                                           DataFrame dataFrame, String... params) {

        // step5 TODO: 2016/6/12
        // alternatively, define CountVectorizerModel with a-priori vocabulary
        CountVectorizerModel cvm = new CountVectorizerModel(vocabulary).setInputCol(input).setOutputCol(output);
    ...
    public JavaRDD<Row> getJavaRdd() {
        ...
        JavaRDD<Row> jrd = jsc.parallelize(Arrays.asList(RowFactory.create(Arrays.asList("a", "b", "c")),
